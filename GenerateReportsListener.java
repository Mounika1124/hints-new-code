...
public class GenerateReportsListener implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		count_totalTCs = count_totalTCs + 2;
	...
	public void onTestSuccess(ITestResult result) {
		...
		String screenshotPath1 = Utility.captureScreenshotFromBase64(driver);
		...
		try {
			report.attachScreeshot(screenshotPath1);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		report.logTestFailed("<span class='label failure'>" + result.getMethod().getMethodName() + "</span>",
				"<pre>Results = " + result.getThrowable().getCause() + "\n\n GET MESSAGE : "
