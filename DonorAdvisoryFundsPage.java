...
public class DonorAdvisoryFundsPage {

	WebDriver driver;
	Utility util = new Utility(driver, 30);

	public DonorAdvisoryFundsPage(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = "//div[@id=\"DONOR_ADVISORY_FUNDS\"]")
	public WebElement donorAdvisoryFundsMenu;
	...
	@FindBy(xpath = "//ul[@class=\"MuiList-root MuiList-padding MuiMenu-list css-r8u8y9\"]//li[text()=\"ANNADAANA\"]")
	public WebElement annadaanaValue;

	@FindBy(xpath = "//ul[@class=\"MuiList-root MuiList-padding MuiMenu-list css-r8u8y9\"]//li[text()=\"VASTRA\"]")
	public WebElement vastraValue;
	...
	public void navigateToDonorAdvisory() throws InterruptedException {
...
//		System.out.println(purposeOfDonation.getText());
		...
		if (purposeOfDonation.getText().equals("ANNADAANA")) {
			...
			Thread.sleep(2000);
			descriptiontextfield.sendKeys("test donor advisory funds");
			addBtn.click();
			Thread.sleep(1000);
...
//				disbursementReference.sendKeys(String.valueOf(randomReference1));
			...
			FirstColumn.get(SignInNameIndex).click();
			Thread.sleep(2000);
			descriptiontextfield.sendKeys("test Donor Advisory donations");
			addBtn.click();
			Thread.sleep(1000);
...
//			closeButton.click();
	...
	// If amount in do1lar field is not equal to amount field
